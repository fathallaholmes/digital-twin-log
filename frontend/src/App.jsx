        ...
        <div className="flex items-center justify-between flex-wrap gap-2">
          <div>
            ...
            <p className="text-xs text-slate-500">
              ...
              {enTransit > 0 && <span className="ml-2 text-purple-600 font-semibold">· {enTransit} en transit</span>}
            </p>
          </div>
          <div className="flex items-center gap-3">
            ...
            <button
              ...
              className="text-xs px-3 py-1.5 rounded-md bg-slate-800 hover:bg-slate-700 text-white font-medium"
            >
              🛠 Gérer la flotte
            </button>
          </div>
